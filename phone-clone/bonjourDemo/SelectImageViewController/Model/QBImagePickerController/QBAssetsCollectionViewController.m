...
@interface QBAssetsCollectionViewController ()<BarButtonItemDelegate>
...
//    }
    [self changeButtonStateNumber];
}
-(void)changeButtonStateNumber{
    ...
    if (self.allowsMultipleSelection) {
        ...
        if ([self validateNumberOfSelections:self.imagePickerController.selectedAssetURLs.count]) {
            ...
            self.completeButton.enabled = [self validateNumberOfSelections:self.imagePickerController.selectedAssetURLs.count];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Validation
    if (self.allowsMultipleSelection) {
        self.completeButton.enabled = [self validateNumberOfSelections:(self.imagePickerController.selectedAssetURLs.count + 1)];
        [self.completeButton setTitleColor:[UIColor colorWithRed:30.0/255 green:144.0/255 blue:1.0 alpha:1.0] forState:UIControlStateNormal];
    }
